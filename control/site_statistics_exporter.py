...
def export_site_statistics_workbook(
    ...
    *,
    ...
    wb = Workbook()
    _write_overview_sheet(wb.active, report_set)
    _write_report_list_sheet(wb.create_sheet("修改單清單"), report_set)
    _write_weld_summary_sheet(wb.create_sheet("焊口統計"), report_set)
    _write_photo_index_sheet(wb.create_sheet("照片索引"), report_set)
    _write_photo_sheet(wb.create_sheet("照片表"), report_set)
    _write_material_summary_sheet(wb.create_sheet("用料統計"), report_set)
    _write_issue_sheet(wb.create_sheet("問題清單"), report_set)
...
def _write_overview_sheet(ws, report_set: dict[str, Any]) -> None:
    ws.title = "總覽"
...
def _write_report_list_sheet(ws, report_set: dict[str, Any]) -> None:
    headers = [
...
def _write_weld_summary_sheet(ws, report_set: dict[str, Any]) -> None:
    _write_table(
        ws,
        "焊口統計",
...
def _write_photo_index_sheet(ws, report_set: dict[str, Any]) -> None:
    _write_table(
        ws,
        "照片索引",
...
def _write_photo_sheet(ws, report_set: dict[str, Any]) -> None:
    title = "照片表"
...
def _write_material_summary_sheet(ws, report_set: dict[str, Any]) -> None:
    _write_table(
        ws,
        "用料統計",
...
def _write_issue_sheet(ws, report_set: dict[str, Any]) -> None:
    _write_table(
        ws,
        "問題清單",
        ["報告/資料夾", "問題代碼", "說明"],
