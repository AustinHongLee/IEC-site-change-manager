# -*- coding: utf-8 -*-
"""Build a repeatable showcase from real attachments data."""
...
SHOWCASE_MARKER = ".iec_real_attachments_showcase"


def run_real_attachments_showcase(
...
def build_real_attachments_pdf_template() -> dict[str, Any]:
    return {
        "template_id": "real_attachments_showcase_pdf_overlay",
        "schema_version": "template_mapping.v1",
        "target_schema_version": "pdf_overlay.v1",
        "kind": "pdf_overlay",
        "base_pdf": "showcase_base.pdf",
...
def build_real_attachments_photo_grid_template() -> dict[str, Any]:
    return {
        "template_id": "real_attachments_photo_grid_pdf_overlay",
        "schema_version": "template_mapping.v1",
        "target_schema_version": "pdf_overlay.v1",
        "kind": "pdf_overlay",
        "base_pdf": "showcase_base.pdf",
...
def _showcase_config() -> SiteOutputBundleConfig:
    return SiteOutputBundleConfig(
        marker_file=SHOWCASE_MARKER,
        marker_text="generated real attachments showcase\n",
        result_root_key="showcase",
        exists_error_message="showcase output 已存在，若要重建請加 overwrite：",
        overwrite_refusal_message="拒絕覆寫非 showcase 資料夾：",
        report_set_filename="real_canonical_report_set.json",
        statistics_filename="real_site_statistics.xlsx",
        summary_template_filename="real_pdf_overlay.template.json",
        photo_grid_template_filename="real_photo_grid.template.json",
        base_pdf_filename="showcase_base.pdf",
        summary_filename="showcase_summary.json",
        summary_template_file_key="pdf_template",
        photo_grid_template_file_key="photo_grid_template",
        summary_pdf_prefix="real_pdf_overlay",
        photo_grid_pdf_prefix="real_photo_grid",
        summary_template_builder=build_real_attachments_pdf_template,
        photo_grid_template_builder=build_real_attachments_photo_grid_template,
    )
